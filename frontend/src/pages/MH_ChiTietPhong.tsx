          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-wrap gap-3">
              <div className="flex items-center gap-2 bg-[#0D631B]/10 px-4 py-1.5 rounded-full">
                ...
                <span className="text-[12px] font-semibold text-[#0D631B]">Sức chứa: {phong.SucChuaToiDa < 10 ? `0${phong.SucChuaToiDa}` : phong.SucChuaToiDa} Người</span>
              </div>
              <div className="flex items-center gap-2 bg-[#EBEDF7] px-4 py-1.5 rounded-full">
                <User className="w-4 h-4 text-[#40493D]" />
                <span className="text-[12px] font-semibold text-[#40493D]">Giới tính: {phong.GioiTinhChoPhep}</span>
              </div>
              <div className="flex items-center gap-2 bg-[#EBEDF7] px-4 py-1.5 rounded-full">
                <BedDouble className="w-4 h-4 text-[#40493D]" />
                <span className="text-[12px] font-semibold text-[#40493D]">Loại phòng: {phong.LoaiPhong}</span>
              </div>
            </div>
          </div>
          ...
          <Card className="rounded-[16px] shadow-sm border border-[#BFCAba]/30 bg-white overflow-hidden">
            <CardHeader className="flex flex-row items-center justify-between bg-white border-b px-8 py-6">
              <div className="flex flex-col gap-1">
                <CardTitle className="text-[20px] font-bold text-[#181C22]">Sơ đồ giường</CardTitle>
                <p className="text-[12px] text-[#40493D]">Trạng thái thời gian thực</p>
              </div>
              <div className="flex items-center gap-4 bg-[#F1F3FC] px-4 py-2 rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-bold text-[#181C22]">Trống</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2.5 h-2.5 rounded-full bg-[#FBBF24]"></div>
                  <span className="text-[10px] font-bold text-[#181C22]">Đã cọc</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2.5 h-2.5 rounded-full bg-[#EF4444]"></div>
                  <span className="text-[10px] font-bold text-[#181C22]">Đã thuê</span>
                </div>
              </div>
            </CardHeader>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-5">
                {phong.Giuong?.map((g: any, index: number) => {
                  ...
                  if (g.TrangThai === "Đã thuê") {
                    ...
                    shadow = "shadow-[0_4px_6px_-4px_rgba(254,202,202,0.5),0_10px_15px_-3px_rgba(254,202,202,0.5)]";
                  }
                  if (g.TrangThai === "Đã cọc") {
                    bgColor = "bg-white border-yellow-100";
                    textColor = "text-yellow-600";
                    shadow = "shadow-[0_4px_6px_-4px_rgba(253,230,138,0.5),0_10px_15px_-3px_rgba(253,230,138,0.5)]";
                  }
          ...
          <Card className="rounded-[28px] shadow-sm border border-[#E5E7EB] bg-white">
            ...
            <CardContent className="flex flex-col gap-5 px-10 pb-10 pt-3">
              {phong.TieuChi && phong.TieuChi.length > 0 ? (
                ...
                <div className="text-[14px] text-gray-500 italic">Chưa có tiêu chí nào</div>
              )}
            </CardContent>
          </Card>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-2">
        <Card className="rounded-[16px] shadow-sm border border-[#BFCAba]/30 overflow-hidden bg-white">
          <CardHeader className="px-8 pt-8 pb-4 flex flex-row items-center gap-3">
            ...
            <CardTitle className="text-[20px] font-bold text-[#0D631B]">Tài sản trong phòng</CardTitle>
          </CardHeader>
        ...
        <Card className="rounded-[16px] shadow-sm border border-[#BFCAba]/30 overflow-hidden bg-white">
          <CardHeader className="px-8 pt-8 pb-4 flex flex-row items-center gap-3">
            ...
            <CardTitle className="text-[20px] font-bold text-[#0D631B]">Dịch vụ tại chi nhánh</CardTitle>
          </CardHeader>
          <CardContent className="p-8 pt-0">
            <div className="flex flex-wrap gap-3">
