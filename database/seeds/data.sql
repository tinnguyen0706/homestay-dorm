...
VALUES
    ('X', 'Chi nhánh Quận 1', '123 Nguyễn Trãi, Quận 1, TP.HCM'),
    ('X', 'Chi nhánh Quận 9', '456 Lê Văn Việt, Quận 9, TP.HCM'),
    ('X', 'Chi nhánh Hải Châu', '789 Hoàng Diệu, Hải Châu, Đà Nẵng');
...
INSERT INTO KHACHHANG
    (MaKH, HoTen, GioiTinh, Email, QuocTich, SDT, MaNhomThue)
VALUES
...
INSERT INTO NHOMTHUE
    (MaNhomThue, MaKH_DaiDien)
VALUES
    ('X', 'KH001'),
    ('X', 'KH003');
...
INSERT INTO PHONG
    (MaPhong, TenPhong, SucChuaToiDa, GioiTinhChoPhep, TrangThai, MaLoai, MaChiNhanh)
VALUES
    -- Chi nhánh CN001
...
INSERT INTO TAIKHOAN_NV
    (MaTaiKhoanNV, Username, Password, MaNV)
VALUES
...
INSERT INTO TAISAN
    (MaTaiSan, TenTaiSan, GiaDenBu, MaPhong, Loai)
VALUES
    -- PH001  → TS001-TS005
...
INSERT INTO GIUONG
    (MaTaiSan, GiaThueGiuong, TrangThai)
VALUES
    -- PH001
    ('TS001', 1500000, 'Đã thuê'),
    ('TS002', 1500000, 'Đã thuê'),
    ('TS003', 1500000, 'Trống'),
    -- PH002
    ('TS006', 1500000, 'Đã thuê'),
    ('TS007', 1500000, 'Đã thuê'),
    ('TS008', 1500000, 'Đã thuê'),
    -- PH003
    ('TS011', 1500000, 'Trống'),
    ('TS012', 1500000, 'Đã cọc'),
    ('TS013', 1500000, 'Trống'),
    -- PH004
    ('TS016', 1800000, 'Trống'),
    ('TS017', 1800000, 'Trống'),
    ('TS018', 1800000, 'Trống'),
    -- PH005
    ('TS021', 1200000, 'Đã thuê'),
    ('TS022', 1200000, 'Đã thuê'),
    ('TS023', 1200000, 'Đã thuê'),
    -- PH006
    ('TS026', 1000000, 'Trống'),
    ('TS027', 1000000, 'Trống'),
    -- PH007
    ('TS031', 1000000, 'Đã thuê'),
    ('TS032', 1000000, 'Trống'),
    -- PH008
    ('TS036', 2000000, 'Đã thuê'),
    ('TS037', 2000000, 'Đã thuê'),
    -- PH009
    ('TS041', 1000000, 'Trống'),
    ('TS042', 1000000, 'Đã cọc'),
    -- PH010
    ('TS046', 2000000, 'Đã thuê'),
    ('TS047', 2000000, 'Đã thuê'),
    -- PH011
    ('TS051', 1000000, 'Trống'),
    ('TS052', 1000000, 'Trống'),
    -- PH012
    ('TS056', 1500000, 'Đã thuê'),
    ('TS057', 1500000, 'Đã thuê'),
    -- PH013
    ('TS061', 1000000, 'Trống'),
    ('TS062', 1000000, 'Trống'),
    -- PH014
    ('TS066', 2000000, 'Đã thuê'),
    ('TS067', 2000000, 'Trống'),
    -- PH015
    ('TS071', 1000000, 'Trống'),
    ('TS072', 1000000, 'Đã cọc');

-- =============================================================================
-- TIER 4: PHONG_TIEUCHI  (3 tiêu chí / phòng = 45 records)
-- =============================================================================

INSERT INTO PHONG_TIEUCHI
    (MaPhong, MaTieuChi)
VALUES
    ('PH001', 'TC001'),
    ('PH001', 'TC003'),
